...
const Visa = ({width,height}) => {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width={width} height={height}
            ...
            <g>
                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-0.7012" y1="508.915" x2="1.2988" y2="508.915" gradientTransform="matrix(22.7909 -84.3269 -84.3269 -2.3766 43164.5352 1492.2937)">
                    <stop offset="0%" stopColor='#222357'/>
                    <stop offset="100%" stopColor="#254AA5" />
                </linearGradient>
                <path fill="url(#SVGID_1_)" d="M264.8,226.2c-0.3,23,20.5,35.9,36.2,43.5c16.1,7.8,21.5,12.9,21.5,19.9c-0.1,10.7-12.9,15.5-24.8,15.7
